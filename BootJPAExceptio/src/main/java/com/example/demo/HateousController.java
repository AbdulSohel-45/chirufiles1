...
//		ent.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(ControllerMy.class).delEmployee(employee.getId())).withRel("delEmployee"));
//		ent.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(ControllerMy.class).deleteEmployee()).withRel("deleteEmployee"));
		...
		ent.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(ControllerMy.class).info()).withRel("infoINFO"));
//		ent.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(ControllerMy.class).done()).withRel("done"));
//		ent.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(ControllerMy.class).delEmployee(employee.getId())).withRel("delete"));
		return ent;
